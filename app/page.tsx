...
function DesignitLogo({ themeMode }: any) {
  const fill = themeMode === "light" ? "#111111" : "#ffffff"
  return (
    <svg viewBox="0 0 193.6 66" style={{ height: 32, width: "auto" }} aria-label="Designit" fill={fill} xmlns="http://www.w3.org/2000/svg">
      <path d="M33.7,18.9c0,11.1-8.8,18.4-18.8,18.4H0.4V0.5h14.5C25,0.5,33.7,7.8,33.7,18.9L33.7,18.9z M14.9,31.3
        c6.8,0,12.1-5.4,12.1-12.3C27,12,21.8,6.6,14.9,6.6H7.1v24.7H14.9z M58.2,28.5l5.5,2.3c-2.7,5-7.1,7.3-12.6,7.3
        C43,38.1,37,32.2,37,24.2c0-7.7,5.8-14.3,13.5-14.3c8.9,0,14.4,7.2,13.1,16.1H43.3c0.8,4,3.8,6.7,7.9,6.7
        C54.7,32.6,56.7,31,58.2,28.5L58.2,28.5z M43.5,20.9h14.2c-0.8-3.5-3.3-5.7-7.2-5.7C46.9,15.2,44.3,17.4,43.5,20.9L43.5,20.9z
         M66.8,30.9l5.4-1.9c1,2.6,3.4,4,7.2,4c3.7,0,5.4-1.3,5.4-3.3c0-1.7-1.2-2.5-4.3-3L78,26.3c-6.3-0.8-10.1-3-10.1-7.8
        c0-4.9,4.3-8.7,11.1-8.7c6.3,0,10.1,2.8,11.7,6.9l-5.5,1.8c-1-2.1-2.7-3.5-6.3-3.5c-3.2,0-4.8,1.2-4.8,3.2c0,1.6,1.6,2.4,4.6,2.8
        l2.4,0.3c6.3,0.8,9.7,2.9,9.7,8c0,4.7-3.8,8.8-11.3,8.8C71.8,38.1,68.1,34.9,66.8,30.9L66.8,30.9z M94.4,4c0-1.6,0.9-3,2.3-3.7
        c1.4-0.6,3.1-0.3,4.2,0.8c1.1,1.1,1.5,2.8,0.9,4.3c-0.6,1.5-2,2.4-3.6,2.4C96.1,7.8,94.4,6.1,94.4,4L94.4,4z M95.1,37.3V10.7h6.3
        v26.6L95.1,37.3z M123.6,35.8c5.4,0,8.5,2.5,8.5,7.4V46h-5.9v-1.7c0-1.9-1.4-2.9-3.4-2.9h-9.3c-6,0-8-3.4-8-6.1
        c0-2.1,0.9-4.2,3.4-6.5c-2-2-3.1-4.8-3.1-7.7c0-6.4,5.3-11.3,12.3-11.3c2.5,0,5,0.6,7.1,1.9l3.7-3.5l3.5,3.8l-3.4,3.3
        c1,1.7,1.6,3.7,1.6,5.7c0,6.5-5.4,11.3-12.4,11.3c-1.8,0-3.6-0.3-5.3-1c-0.9,0.8-1.3,1.5-1.3,2.3c0,1.3,1.1,2.1,3,2.1L123.6,35.8z
         M111.8,21.1c0,3.5,2.6,6.1,6.3,6.1s6.4-2.6,6.4-6.1c0-3.4-2.6-6-6.4-6C114.4,15.1,111.8,17.8,111.8,21.1L111.8,21.1z M160.9,20.1
        v17.2h-6.2V21.8c0-3.8-1.9-6.1-5.9-6.1c-3.8,0-6.2,2.5-6.7,3.6v18h-6.2V10.7h5.3l0.7,3.3c1.8-2.5,5-4.1,8.7-4.1
        C156.2,10,160.9,14.2,160.9,20.1L160.9,20.1z M165.7,0.5h7V7h-7V0.5z M166,37.3V10.7h6.2v26.6H166z M193.6,16.3h-6.7v12.3
        c0,2.1,0.9,3.1,3.3,3.1h3.4v5.7h-4.7c-6,0-8.2-3-8.2-8V16.3h-4.5v-5.5h4.5V2.6h6.2v8.1h6.7L193.6,16.3z M8.4,61.6v1.7H7.2
        c-0.7,0-1.2-0.3-1.4-0.9c-0.7,0.7-1.6,1.1-2.6,1.1c-2,0-3.2-1.1-3.2-2.6c0-1.6,1.2-2.7,3.6-2.7h2.2v-0.3c0-0.9-0.6-1.6-1.8-1.6
        c-0.8,0-1.6,0.4-1.9,1.2L0.2,57c0.5-1.1,1.7-2.3,3.8-2.3c2.5,0,3.6,1.4,3.6,3.1v3.3c0,0.4,0.1,0.5,0.5,0.5L8.4,61.6z M5.8,60.9
        v-1.3H3.8C2.6,59.6,2,60,2,60.8C2,61.5,2.6,62,3.6,62C4.5,62,5.3,61.6,5.8,60.9L5.8,60.9z M22.9,54.9h2l-2,8.3h-2.3l-1.5-4l-1.5,4
        h-2.2l-2-8.3h2.1l1.3,6l1.5-4.1h1.7l1.5,4.1L22.9,54.9z M26.3,52.8c0-0.5,0.3-0.9,0.7-1.1c0.4-0.2,1-0.1,1.3,0.2
        c0.8,0.8,0.2,2.1-0.9,2.1C26.8,54,26.3,53.5,26.3,52.8L26.3,52.8z M26.5,63.3v-8.3h2v8.3H26.5z M39.3,59.1c0,2.5-1.7,4.4-4.1,4.4
        c-1,0-1.9-0.4-2.6-1.1V66h-2V54.9h1.7l0.2,1c0.7-0.8,1.7-1.2,2.7-1.2C37.7,54.7,39.3,56.6,39.3,59.1L39.3,59.1z M37.3,59.1
        c0.1-1.4-1.1-2.6-2.5-2.6c-0.9,0-1.7,0.4-2.2,1.2v2.9c0.5,0.8,1.3,1.2,2.2,1.2C36.3,61.7,37.3,60.6,37.3,59.1L37.3,59.1z
         M45.8,54.9v1.8h-1c-1.2,0-1.9,0.7-2,1.3v5.2h-2v-8.3h1.7l0.2,1.2c0.4-0.8,1.2-1.2,2.1-1.2H45.8z M46.4,59.1c0-1.8,1-3.5,2.7-4.2
        c1.7-0.7,3.6-0.4,4.9,0.9c1.3,1.3,1.7,3.2,1,4.9c-0.7,1.7-2.3,2.8-4.1,2.8c-1.2,0-2.3-0.4-3.2-1.3C46.9,61.4,46.4,60.3,46.4,59.1
        L46.4,59.1z M53.4,59.1c0-1.5-1-2.6-2.5-2.6c-1.5,0-2.5,1.2-2.5,2.6c0,1.5,1,2.7,2.5,2.7C52.4,61.8,53.4,60.6,53.4,59.1L53.4,59.1
        z M60.7,59.1c0-1.2,0.4-2.3,1.2-3.1c0.8-0.8,1.9-1.3,3.1-1.3c1.6,0,3.1,0.9,3.8,2.4L67,57.8c-0.4-0.8-1.2-1.3-2.1-1.3
        c-1.4,0-2.3,1.2-2.3,2.6c0,1.5,1,2.7,2.4,2.7c1.1,0,1.7-0.5,2.2-1.5L69,61c-0.6,1.6-2.2,2.6-3.9,2.6c-1.2,0-2.3-0.5-3.1-1.3
        C61.1,61.4,60.7,60.3,60.7,59.1L60.7,59.1z M69.8,59.1c0-1.8,1-3.5,2.7-4.2c1.7-0.7,3.6-0.4,4.9,0.9c1.3,1.3,1.7,3.2,1,4.9
        c-0.7,1.7-2.3,2.8-4.1,2.8c-1.2,0-2.3-0.4-3.2-1.3C70.3,61.4,69.8,60.3,69.8,59.1L69.8,59.1z M76.8,59.1c0-1.5-1-2.6-2.5-2.6
        c-1.5,0-2.5,1.2-2.5,2.6c0,1.5,1,2.7,2.5,2.7C75.8,61.8,76.8,60.6,76.8,59.1L76.8,59.1z M93.2,57.9v5.4h-2v-4.9
        c0-1.2-0.6-1.9-1.7-1.9c-0.8,0-1.5,0.4-1.9,1.1v5.7h-2v-4.9c0-1.2-0.5-1.9-1.7-1.9c-0.8,0-1.5,0.4-1.9,1.1v5.7h-2v-8.3h1.7l0.2,1
        c0.6-0.8,1.5-1.3,2.5-1.2c1,0,1.9,0.5,2.5,1.3c0.7-0.8,1.8-1.3,2.9-1.3C91.8,54.7,93.2,56.1,93.2,57.9L93.2,57.9z M103.8,59.1
        c0,2.5-1.7,4.4-4.1,4.4c-1,0-1.9-0.4-2.6-1.1V66h-2V54.9h1.7l0.2,1c0.7-0.8,1.7-1.2,2.7-1.2C102.2,54.7,103.9,56.6,103.8,59.1
        L103.8,59.1z M101.8,59.1c0.1-1.4-1.1-2.6-2.5-2.6c-0.9,0-1.7,0.4-2.2,1.2v2.9c0.5,0.8,1.3,1.2,2.2,1.2
        C100.8,61.7,101.9,60.6,101.8,59.1L101.8,59.1z M113.3,61.6v1.7h-1.2c-0.7,0-1.2-0.3-1.4-0.9c-0.7,0.7-1.6,1.1-2.6,1.1
        c-2,0-3.3-1.1-3.3-2.6c0-1.6,1.2-2.7,3.6-2.7h2.2v-0.3c0-0.9-0.6-1.6-1.8-1.6c-0.8,0-1.6,0.4-1.9,1.2l-1.8-0.5
        c0.5-1.1,1.7-2.3,3.8-2.3c2.5,0,3.6,1.4,3.6,3.1v3.3c0,0.4,0.2,0.5,0.5,0.5L113.3,61.6z M110.6,60.9v-1.3h-1.9
        c-1.2,0-1.8,0.4-1.8,1.2c0,0.7,0.6,1.2,1.6,1.2C109.4,62,110.2,61.6,110.6,60.9L110.6,60.9z M122.7,57.9v5.4h-2v-4.9
        c0-1.2-0.6-1.9-1.9-1.9c-0.8,0-1.6,0.4-2.1,1.1v5.7h-2v-8.3h1.7l0.2,1.1c0.7-0.8,1.7-1.3,2.7-1.3C121.3,54.7,122.7,56,122.7,57.9
        L122.7,57.9z M130.1,54.9h2.1l-4,9.7c-0.5,1.2-0.9,1.4-2.2,1.4h-1.2v-1.6h0.9c0.6,0,0.8-0.2,1-0.7l0.2-0.5l-3.4-8.2h2.2l2.2,5.8
        L130.1,54.9z M130.1,54.9" />
    </svg>
  )
}
          ...
          <DropdownWrapper open={orgOpen} setOpen={setOrgOpen}
            trigger={
              <HoverBtn onClick={() => setOrgOpen(!orgOpen)} style={{ display: "flex", alignItems: "center", gap: 6, padding: "4px 6px", borderRadius: 6, border: "none", background: "transparent", cursor: "pointer", color: t.fg }}>
                <DesignitLogo themeMode={themeMode}/>
