...
export default function App() {
  ...
  function renderMain() {
    if (activeItem === "Offices") return <OfficesPage people={people} departments={departments} groups={INITIAL_GROUPS} roles={roles} onNavigateToPeople={(o: string) => { setFilteredOfficeForPeople(o); setInitialPeopleView(null); setActiveItem("People"); setBreadcrumb(["The Grid", "People"]) }} onNavigateToDepartments={(o: string) => { setFilteredOfficeForPeople(o); setInitialPeopleView("departments"); setActiveItem("People"); setBreadcrumb(["The Grid", "People"]) }} onNavigateToGroups={(o: string) => { setFilteredOfficeForPeople(o); setInitialPeopleView("groups"); setActiveItem("People"); setBreadcrumb(["The Grid", "People"]) }}/>
